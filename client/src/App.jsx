            ...
            {isLoading && (
              <div className="loading-container">
                ...
                <div className="loading-content">
                  <div className="loading-text">{pollingMessage}</div>
                  <div className="loading-subtext">
                    {currentStep === 'ranking' && totalProducts > 0
                      ? `AI is analyzing ${scoredCount} of ${totalProducts} products`
                      : 'Our AI agent is finding the best local options for you'
                    }
                  </div>

                </div>
                <div className="progress-steps">
                  <div className={`progress-step ${stepIndex >= 0 ? 'active' : ''} ${stepIndex > 0 ? 'complete' : ''}`}>
                  ...
                  <div className={`progress-step ${stepIndex >= 1 ? 'active' : ''} ${stepIndex > 1 ? 'complete' : ''}`}>
                    <div className="step-icon">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path>
                        <polyline points="9 22 9 12 15 12 15 22"></polyline>
                  ...
                  <div className={`progress-step ${stepIndex >= 2 ? 'active' : ''} ${stepIndex > 2 ? 'complete' : ''}`}>
                    <div className="step-icon">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  ...
                  <div className={`progress-step ${stepIndex >= 3 ? 'active' : ''}`}>
                    <div className="step-icon">
                      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <polyline points="20 6 9 17 4 12"></polyline>
                      </svg>
